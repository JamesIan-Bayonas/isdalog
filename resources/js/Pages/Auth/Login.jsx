...
export default function Login({ status, canResetPassword }) {
    ...
    // Decorative only — this preview is local UI state, not part of the
    // login form. Nothing here touches data/post/route.
    const roleData = {
        fisherman: {
    ...
    return (
        <>
            <Head title="Log in — IsdaLog Maritime Hub" />
            ...
            <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-[#020617] text-slate-100 selection:bg-cyan-500 selection:text-white relative overflow-hidden">
                ...
                <div className="hidden lg:flex lg:col-span-5 flex-col justify-between p-12 relative z-10 border-r border-slate-800/70 bg-slate-950/50 backdrop-blur-xl">
                    ...
                    {/* Sonar Console + Role Contacts (preview only) */}
                        ...
                        <div className="flex gap-6 items-center pt-1">
                            <svg viewBox="0 0 220 220" className="w-40 h-40 shrink-0" role="img" aria-label="Platform role scope">
                                ...
                                <g className="vela-sweep-arm">
                                    <path d="M110 110 L110 10 A100 100 0 0 1 178 42 Z" fill="url(#sweepGradientLogin)" opacity="0.55" />
                                </g>
                                <defs>
                                    <linearGradient id="sweepGradientLogin" x1="110" y1="10" x2="178" y2="42" gradientUnits="userSpaceOnUse">
                ...
                <div className="col-span-1 lg:col-span-7 flex items-center justify-center p-6 sm:p-12 relative z-10">
                    <div className="w-full max-w-md space-y-8">
                        ...
                        {/* Status Message — same conditional, restyled from plain green text */}
                        {status && (
                        ...
                        {/* Login Form — same fields, same onSubmit, same post/reset behavior */}
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <div className="mt-1.5 relative rounded-xl shadow-sm group">
                                    ...
                                    />
                                    {/* Added show/hide toggle — pure UI state, doesn't touch data.password */}
                                    <button
                                        type="button"
                            ...
                            {/* SUBMIT BUTTON — replaces PrimaryButton with a themed button, same disabled={processing} */}
                            <button
                                type="submit"
                                disabled={processing}
